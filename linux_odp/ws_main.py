...
main_src = SrcGroup(dir='src',
        src_list=[
             ...
             'pal/linux_odp/pal_utl.cpp',
             'pal/linux_odp/mbuf.cpp'
             ]);
...
common_flags = ['-DWIN_UCODE_SIM',
               ...
               # '-include','../src/pal/linux_odp/rte_config.h',
...
includes_path =''' ../src/pal/linux_odp/
                   ../src/
                   ...
                   ../external_libs/odp/helper/include/odp
            ''';
...
def build_prog (bld, build_obj):
    ...
    odp_lib_path='external_libs/odp/'
    bld.read_shlib( name='odp' , paths=[top+odp_lib_path] )
    bld.read_shlib( name='odphelper' , paths=[top+odp_lib_path] )
...
#      );
    ...
    bld.program(features='cxx cxxprogram', 
                ...
                lib=['pthread','dl'],
                use =[build_obj.get_dpdk_target(),'zmq', 'odp', 'odphelper'],
